...
def run_migrations():
    ...
    migrations = [
        ...
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS phone_status VARCHAR DEFAULT 'not_verified'",
        ...
        "ALTER TABLE professionals ADD COLUMN IF NOT EXISTS verification_status VARCHAR DEFAULT 'pending_verification'",
        ...
        "ALTER TABLE bookings ADD COLUMN IF NOT EXISTS no_show_who VARCHAR",
        "ALTER TABLE bookings ADD COLUMN IF NOT EXISTS review_type VARCHAR",
        "ALTER TABLE bookings ADD COLUMN IF NOT EXISTS gps_exception_reason TEXT",
        "ALTER TABLE bookings ADD COLUMN IF NOT EXISTS gps_exception_evidence VARCHAR",
        "ALTER TABLE bookings ADD COLUMN IF NOT EXISTS gps_fraud_detected BOOLEAN DEFAULT FALSE",
        "ALTER TABLE bookings ADD COLUMN IF NOT EXISTS gps_fraud_flags JSON DEFAULT '[]'",
        "ALTER TABLE bookings ADD COLUMN IF NOT EXISTS extension_new_end TIMESTAMPTZ",
        "ALTER TABLE bookings ADD COLUMN IF NOT EXISTS extension_requested_by VARCHAR",
        "ALTER TABLE bookings ADD COLUMN IF NOT EXISTS extension_additional_cost FLOAT",
        "ALTER TABLE bookings ADD COLUMN IF NOT EXISTS extension_status VARCHAR",
